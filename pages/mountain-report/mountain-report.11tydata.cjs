...
module.exports = async function() {
    const getSnowReport = await fetch('https://hotel-site-dev.skipperhospitality.com/sundance/snow-report');
    const getLiftReport = await fetch('https://hotel-site-dev.skipperhospitality.com/sundance/lift-report');
